...
import { LiaAngleLeftSolid, LiaAngleDownSolid, LiaAngleUpSolid } from "react-icons/lia";
          ...
          <div className="header-left d-flex align-items-center">
            ...
            <button className="edit bg-primary border-0  d-flex align-items-center justify-content-center">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.75001 3.50137L10.5 5.25137M7.58334 11.668L12.25 11.668M2.91668 9.3347L2.33334 11.668L4.66668 11.0847L11.4252 4.3262C11.6439 4.10742 11.7668 3.81073 11.7668 3.50137C11.7668 3.19201 11.6439 2.89532 11.4252 2.67654L11.3248 2.5762C11.1061 2.35749 10.8094 2.23462 10.5 2.23462C10.1907 2.23462 9.89396 2.35749 9.67518 2.5762L2.91668 9.3347Z" stroke="#151B22" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </button>
          </div>
          ...
          <div className="createStrategies-leftBar">
            ...
            <div className="action-panel">
              <div className="single ">
                ...
                <div class="dashboard-topBar-search bg-white rounded-3 position-relative z-1 d-none d-md-block">
                  <div class="icon d-flex align-items-center justify-content-center position-absolute top-50 translate-middle-y ms-3">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M15.75 15.7502L12.4928 12.4929M12.4928 12.4929C13.0499 11.9357 13.4919 11.2743 13.7934 10.5463C14.095 9.81834 14.2502 9.03811 14.2502 8.25015C14.2502 7.4622 14.095 6.68197 13.7934 5.95399C13.4919 5.22602 13.0499 4.56457 12.4928 4.0074C11.9356 3.45024 11.2741 3.00827 10.5462 2.70673C9.81819 2.4052 9.03795 2.25 8.25 2.25C7.46205 2.25 6.68181 2.4052 5.95384 2.70673C5.22587 3.00827 4.56442 3.45024 4.00725 4.0074C2.882 5.13265 2.24985 6.65881 2.24985 8.25015C2.24985 9.84149 2.882 11.3677 4.00725 12.4929C5.1325 13.6182 6.65866 14.2503 8.25 14.2503C9.84134 14.2503 11.3675 13.6182 12.4928 12.4929Z" stroke="currentColor" stroke-opacity="0.2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                  </div>
                  <input type="search" placeholder="Search" class="form-control border-0 bg-transparent" />
                </div>
