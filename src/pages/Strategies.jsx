              ...
              <div className="btn-wrap">
                <a href="#" className="btn" id='primaryIcon'>
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 3.625H2.25C1.95163 3.625 1.66548 3.74353 1.4545 3.9545C1.24353 4.16548 1.125 4.45163 1.125 4.75V10.75C1.125 11.0484 1.24353 11.3345 1.4545 11.5455C1.66548 11.7565 1.95163 11.875 2.25 11.875H8.25C8.54837 11.875 8.83452 11.7565 9.04549 11.5455C9.25647 11.3345 9.375 11.0484 9.375 10.75V7" stroke="currentColor" strokeLinecap="round" />
          ...
          {isList &&
            <div className="list-view mt-3 mt-md-4">
              <div className="createdByMe mb-4">
                <h3 id="title" className='text-heading fs-16 fw-bold lh-base p-3 m-0 pb-0'>Created By Me</h3>
                <div className="profile-profit-cards m-0  p-3  lists table w-100">
                  ...
                  {profitCard.map((item, index) => (
                    <div className="profile-profit-card lists-list bg-white tr w-100 d-flex align-items-center" key={index}>
                      ...
                      <div className="td">
                        <p className='fs-14 mb-2 pb-2  lh-base mr-6'>{item.des} <button onClick={() => setDetailsModal(!detailsModal)} className='read p-0 bg-transparent border-0 fw-semibold'> {item.read_more}</button></p>
                      </div>
                      <div className="td">
              ...
              <div className="fromMarketplace">
                <h3 id="title" className='text-heading fs-16 fw-bold lh-base p-3 m-0 pb-0'>Marketplace</h3>
                <div className="profile-profit-cards m-0 p-3  lists table w-100">
                  <div className="tr d-flex">
                    {listHead.map((item, index) => (
                      <div className="th d-flex gap-2 align-items-center" key={index}>{item.name}<TfiAngleDown /></div>
