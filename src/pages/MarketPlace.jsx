...
import icon1 from "../assets/img/marketicon1.png"
import icon2 from "../assets/img/marketicon1.png"
import icon3 from "../assets/img/marketicon1.png"
import icon4 from "../assets/img/marketicon1.png"
import icon5 from "../assets/img/marketicon1.png"
import icon6 from "../assets/img/marketicon1.png"
              ...
              <Col xs={12} lg={6} xl={4} className='marketplace-items-cards mb-2 mb-md-3' key={idx}>
                <div className="marketplace-items-cards-card">
                  ...
                  <Row className="all-valur-history mb-3">
                    {
                      item.values.map((itm, iddx) => (
                        <Col xs={12} md={6} className='mb-2' key={iddx}>
                          <div className='total-value d-flex align-items-center gap-2 p-2' >
                            <div className="image-area">
                              <img src={itm.image} alt="" />
                            </div>
                            <div className='values'>
                              <p className='mb-1 price'>{itm.price}</p>
                              <p>{item.value}</p>
                            </div>
                          </div>
                        </Col>
                  ...
                  <div className='btns d-flex align-items-center'>
                    <Link to="/" className='text-center'>Subscribe</Link>
                    <div className="wish">
